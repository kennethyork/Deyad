...
describe('loadSettings / saveSettings', () => {
  ...
  it('round-trips settings', () => {
    ...
    const custom: DeyadSettings = { ollamaHost: 'http://myhost:1234', defaultModel: 'llama3', autocompleteEnabled: true, completionModel: 'qwen2.5-coder:1.5b', embedModel: 'nomic-embed-text', hasCompletedWizard: true, temperature: 0.7, topP: 0.9, repeatPenalty: 1.1, contextSize: 32768, maxFullHistory: 500, theme: 'dark' };
